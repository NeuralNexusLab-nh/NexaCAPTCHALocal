...
export function widgetHeaders(_request, response, next) {
  ...
  response.setHeader("Content-Security-Policy", `default-src 'none'; base-uri 'none'; object-src 'none'; frame-ancestors ${ancestors}; form-action 'none'; script-src 'self'; style-src 'self'; img-src 'self' data:; connect-src 'self'`);
